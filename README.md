...
**EventManager** is a microservice that is subscribed to a `datamanger-reading` topic of the MQTT and if it detects data that is anomaly in defined scope it should send it to the `eventmanager-anomalies`.
