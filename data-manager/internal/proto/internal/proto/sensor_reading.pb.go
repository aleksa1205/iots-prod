...
func (x *SensorData) GetUsedKw() float64 {
	if x != nil {
		return x.UsedKw
	}
	return 0
...
func (x *SensorData) GetGeneratedKw() float64 {
	if x != nil {
...
func (x *SensorData) GetPressure() float32 {
	if x != nil {
		return x.Pressure
	}
	return 0
...
func (x *SensorData) GetApparentTemperature() float32 {
	if x != nil {
...
func (x *SensorReadingResponse) GetData() *SensorData {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_sensor_reading_proto_rawDesc = "" +
	"\n" +
	"\x14sensor_reading.proto\x1a\x1bgoogle/protobuf/empty.proto\"\xe6\x01\n" +
	"\n" +
	"SensorData\x12\x16\n" +
	...
	"\x04data\x18\x02 \x01(\v2\v.SensorDataR\x04data2\x9d\x01\n" +
...
var file_sensor_reading_proto_goTypes = []any{
	...
	(*SensorReadingGetByIdRequest)(nil), // 1: SensorReadingGetByIdRequest
	(*SensorReadingResponse)(nil),       // 2: SensorReadingResponse
	(*emptypb.Empty)(nil),               // 3: google.protobuf.Empty
}
var file_sensor_reading_proto_depIdxs = []int32{
	0, // 0: SensorReadingResponse.data:type_name -> SensorData
	3, // 1: SensorReadingService.GetSensors:input_type -> google.protobuf.Empty
	1, // 2: SensorReadingService.GetSensorById:input_type -> SensorReadingGetByIdRequest
